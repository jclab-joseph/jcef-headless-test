 ...
 */
class CefBrowserHeadless extends CefBrowser_N implements CefRenderHandler {
    ...
    CefBrowserHeadless(CefClient client, String url, boolean transparent, CefRequestContext context) {
